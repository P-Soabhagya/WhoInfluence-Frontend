...
const VideoCard = ({ video, index, onSelect }) => {
  ...
  return (
    ...
    >
      ...
      ></div>
      <div
        className="relative aspect-9/16 rounded-[28px] overflow-hidden mb-6 transition-all duration-500 bg-[#1E293B] backdrop-blur-md border border-white/10 hover:border-[#f97316]/30 shadow-xl"
      >
      ...
      <div className="flex justify-between items-center px-2">
        ...
        <div className="h-1 w-16 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.1)' }}>
          <div
            ...
            style={{ background: `linear-gradient(90deg, ${color}, #f59e0b)` }}
          />
        </div>
      </div>
    </motion.div>
    ...
    <div className="relative bg-transparent min-h-screen">
      <div className="relative z-10">
        ...
        <main className="pt-24">
          {/* ---- FeaturedVideos Section (copied from FeaturedVideos.jsx) ---- */}
          <section
            id="videos"
            ...
            <div className="max-w-7xl mx-auto relative z-10 mb-16 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              <div>
                <motion.div
                  ...
                  style={{
                    borderColor: 'rgba(189, 120, 30, 0.3)',
                ...
                <motion.h2
                  ...
                  viewport={{ once: false }}
                  className="text-4xl md:text-5xl font-black font-display tracking-tight leading-tight"
                  style={{ color: 'white' }}
                >
                  Content That Drives{' '}
